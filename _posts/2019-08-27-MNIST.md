...
date: 2019-08-27
excerpt: "The MNIST hand-written digits is often considered the equivalent of the print('Hello World')."
project: true
tag:
- neuralnetwork
- cnn
...
It because of the nature of the absolute value, the Lasso regularization tends to drop the coefficients of the model to 0.
...
__Note__: as part of the regularization effort, dropouts are included in the model. The idea behind the use of dropout is to prevent the model from relying too heavily on the same neurons. To do so, a random subset of neurons is deactivated (coefficients set to 0) at each iteration.
